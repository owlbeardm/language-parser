CREATE TABLE evolve_law_tbl (
    ...
    sound_low_id bigint NOT NULL,
    priority int,
    CONSTRAINT evolve_law_pk PRIMARY KEY (id),
    CONSTRAINT evolve_law_lang_from_id_lang_to_id_sound_low_id_unq UNIQUE (lang_from_id,lang_to_id,sound_low_id),
    ...
    CONSTRAINT evolve_law_tbl_sound_low_id_fkey FOREIGN KEY (sound_low_id) REFERENCES sound_low_tbl(id)
);